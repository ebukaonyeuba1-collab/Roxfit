...
body.innerHTML = ` <div class="quiz-result"> <div class="quiz-result-icon">${r.emoji}</div> <h3>Your perfect match is<br><span style="color:var(--rose-deep)">${r.name}</span>!</h3> <p>${r.desc}</p> <a href="programs.html" class="btn btn-primary btn-lg" style="margin-top:8px">View Program →</a> </div>`;
return;
}
